...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+l+'" alt="测试结果" tabindex="0" loading="lazy"><figcaption>测试结果</figcaption></figure>',30)]))}const r=n(p,[["render",c]]),v=JSON.parse('{"path":"/framework/spring/yyxlnugq/","title":"Spring原理手写IoC","lang":"zh-CN","frontmatter":{"title":"Spring原理手写IoC","createTime":"2025/08/27 11:40:32","permalink":"/framework/spring/yyxlnugq/"},"readingTime":{"minutes":3.35,"words":1005},"git":{"createdTime":1756570033000},"filePathRelative":"notes/framework/spring/Spring原理手写IoC.md","headers":[]}');export{r as comp,v as data};
