import{a as n,c as a,b as e,o as i}from"./app-CYzvFbfO.js";const l={};function p(d,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>MyBatis-Flex 提供了 <code>@Column</code> 用来对字段进行更多的配置，以下是 <code>@Column</code> 的代码定义：</p><p>java</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>public @interface Column {</span></span>
