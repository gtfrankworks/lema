import{a as n,c as a,b as e,o as i}from"./app-BE9yW6XZ.js";const l={};function p(d,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>在 MyBatis-Flex 中，内置了非常智能的 <strong>自动映射</strong> 功能，能够使得我们在查询数据的时候，从数据结果集绑定到实体类（或者 VO、DTO 等）变得极其简单易用。</p><h2 id="数据假设" tabindex="-1"><a class="header-anchor" href="#数据假设"><span>数据假设</span></a></h2><p>假设在我们的项目中，有如下的表结构和实体类：</p><p>账户表（tb_account）：</p><p>sql</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>CREATE TABLE IF NOT EXISTS \`tb_account\`</span></span>
...
<span class="line"><span>from tb_account</span></span>
<span class="line"><span>left join tb_book on tb_account.id = tb_book.account_id</span></span>
<span class="line"><span>where tb_account.id &gt;= 100</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时，数据也是可以正常映射。</p>`,103)]))}const t=n(l,[["render",p]]),r=JSON.parse('{"path":"/framework/mybatisflex/base/49svo32u/","title":"自动映射","lang":"zh-CN","frontmatter":{"title":"自动映射","createTime":"2025/08/26 17:19:39","permalink":"/framework/mybatisflex/base/49svo32u/"},"readingTime":{"minutes":5.19,"words":1556},"git":{"createdTime":1757491190000},"filePathRelative":"notes/framework/mybatisflex/base/自动映射.md","headers":[]}');export{t as comp,r as data};
