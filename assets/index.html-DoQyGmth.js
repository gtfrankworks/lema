import{a as n,c as a,b as e,o as i}from"./app-BE9yW6XZ.js";const l={};function p(d,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>在 Entity 类中，MyBatis-Flex 是使用 <code>@Id</code> 注解来标识主键的，如下代码所示：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>@Table(&quot;tb_account&quot;)</span></span>
