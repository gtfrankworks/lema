import{a as n,c as a,b as e,o as i}from"./app-CYzvFbfO.js";const l={};function p(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>字段加密，指的是数据库在存入了明文内容，但是当我们进行查询时，返回的内容为加密内容，而非明文内容。</p><p>以下是 MyBatis-Flex 字段加密示例：</p><p><strong>step 1：</strong> 为实体类编写一个 set 监听器（<code>SetListener</code>）</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>public class AccountOnSetListener implements SetListener {</span></span>
