import{a as n,c as a,b as e,o as i}from"./app-BE9yW6XZ.js";const l={};function p(d,s){return i(),a("div",null,s[0]||(s[0]=[e(`<p>在某些场景下，我们希望在 Entity 中定义的属性是某一个枚举类，而非基本的数据类型，例如：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>@Table(value = &quot;tb_account&quot;)</span></span>
...
<span class="line"><span>where type_enum = 1</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div>`,14)]))}const r=n(l,[["render",p]]),t=JSON.parse('{"path":"/framework/mybatisflex/ad/kynxkngr/","title":"MyBatis-Flex枚举属性","lang":"zh-CN","frontmatter":{"title":"MyBatis-Flex枚举属性","createTime":"2025/08/27 10:01:47","permalink":"/framework/mybatisflex/ad/kynxkngr/"},"readingTime":{"minutes":1.68,"words":503},"git":{"createdTime":1757491190000},"filePathRelative":"notes/framework/mybatisflex/ad/枚举属性.md","headers":[]}');export{r as comp,t as data};
