...
![image-20230604133157078](/images/m108/image-20230604133157078.png)
...
![image-20230529145957465](/images/m108/image-20230529145957465.png)
...
![image-20230604130936471](/images/m108/image-20230604130936471.png)
...
&gt 简单工厂模式违背了开闭原则，而工厂方法模式则是简单工厂模式的进一步深化，其不像简单工厂模式通过一个工厂来完成所有对象的创建，而是**通过不同的工厂来创建不同的对象**，每个对象有对应的工厂创建。
...
&gt 抽象工厂模式是对工厂方法模式的进一步深化。在工厂方法模式中，工厂仅可创建一种对象；然而，在抽象工厂模式中，工厂**不仅可创建一种对象，还可创建一组对象**。
...
![img](/images/m108/v2-add85a7bb2b93d0bd002084715d669dd_b.webp)
...
![img](/images/m108/v2-2ba711eb37a86ab3a1da90ad986e2047_720w.webp)
...
![image-20230525191256477](/images/m108/image-20230525191256477.png)
...
![image-20230526005749721](/images/m108/image-20230526005749721.png)
...
![image-20230526005741671](/images/m108/image-20230526005741671.png)
...
![image-20230526005728556](/images/m108/image-20230526005728556.png)
...
![image-20230526005717545](/images/m108/image-20230526005717545.png)
...
![img](/images/m108/L3Byb3h5L2h0dHAvaW1hZ2VzMjAxNS5jbmJsb2dzLmNvbS9ibG9nLzEwMTcyNDYvMjAxNjA4LzEwMTcyNDYtMjAxNjA4MzAyMzEzMzYxNjgtMTkxNTUxNzI4Ny5wbmc=.jpg)
...
&ltbean id="myBean" class="com.example.MyBean"&gt
    &ltproperty name="count"&gt0&lt/property&gt
&lt/bean&gt
...
![img](/images/m108/springmvc执行流程图.png)
...
public class MyExceptionHandler {
    ...
    public ResponseEntity&ltString&gt handleException(Exception e) {
        return new ResponseEntity&lt&gt("An error occurred: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
```
...
![img](/images/m108/610238-20170527163159169-625947920.png)
...
![img](/images/m108/d746f178eb79455185fa813325996790.png)
...
&gt 一级缓存的作用在我看来在实际业务场景中作用真的非常有限，因为需要在一个事务方法中重复查询的需求场景真的太少，而且由于Mysql数据库的MVCC机制以及事务隔离机制-可重复读的能力，会导致同一个事务方法内多次执行相同的查询必定会得到相同的结果，所以在事务范围内的重复查询基本没什么实际作用。
&gt 设计一级缓存设计的意义，可能更多的是为二级缓存的实现做铺垫。
&gt 所以，如果关闭了mybatis的一级缓存，二级缓存将不会生效。
...
```java
public interface UserMapper extends BaseMapper&ltUser&gt {
    List&ltUser&gt selectUsersWithPage(int pageNum, int pageSize);
}
```
...
```java
Page&ltUser&gt page = new Page&lt&gt(pageNum, pageSize);
List&ltUser&gt users = userMapper.selectUsersWithPage(pageNum, pageSize);
...
```xml
&ltselect id="selectUser" resultType="User"&gt
  select * from user
  &ltwhere&gt
    &ltif test="username != null"&gt
...
```xml
&ltselect id="selectUserByIdList" resultType="User"&gt
  select * from user where id in
  &ltforeach collection="idList" item="id" open="(" close=")"&gt
    #{id}
  &lt/foreach&gt
&lt/select&gt
...
![image-20230525200915482](/images/m108/image-20230525200915482.png)
...
![image-20230529140650694](/images/m108/image-20230529140650694.png)
...
![image-20230529140722243](/images/m108/image-20230529140722243.png)
...
![image-20230529141900841](/images/m108/image-20230529141900841.png)

![image-20230529141920613](/images/m108/image-20230529141920613.png)

![image-20230529140955922](/images/m108/image-20230529140955922.png)
...
![image-20230601175140383](/images/m108/image-20230601175140383.png)
...
2. 配置文件上传
  ...
  4. 在页面上添加文件上传表单
     ...
     ```html
     &ltform method="post" action="/upload" enctype="multipart/form-data" class="form-horizontal"&gt
         &ltdiv class="form-group"&gt
             &ltlabel for="file"&gtSelect file to upload:&lt/label&gt
             &ltinput type="file" name="file" id="file" class="form-control-file"&gt
         &lt/div&gt
         &ltbutton type="submit" class="btn btn-primary"&gtUpload&lt/button&gt
     &lt/form&gt
     ```
...
![image-20230526091110433](/images/m108/image-20230526091110433.png)
...
public class UserController {
    ...
    public List&ltUser&gt getUsers() {
        // 从数据库中获取用户列表
...
![ FreeMarker模板引擎的使用、实现静态化页面_FreeMarker](/images/m108/21201259_63f4b54bd0b5735280.png)

模板 + 数据 = 静态文件

&gt **常用的java模板引擎还有哪些？**
&gt Jsp、Freemarker、Thymeleaf 、Velocity 等。



### 软件开发瀑布模型

![img](/images/m108/1758873-20220511102051347-1013055514.png)
...
<!-- ![img](/images/m108/169c2ccdd3a9c49a~tplv-t2oaga2asx-watermark.image) -->
