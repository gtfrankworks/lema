...
createTime: 2025/08/28 10:04:04
permalink: /java-tutorial/base/umhzvtan/
---
...
上一篇中，我们讲了 如何搭建 Java 开发环境。不过既然确定了要从事 Java 开发，那怎么能少得了一个趁手的 IDE 呢。正所谓工欲善其事。必先利其器，一个趁手的 IDE 就像电视剧里的神兵利器，能让我们功力大增，大大提高我们的效率。
...
![](/images/java/20220703-learn-java-with-idea/ul-vs-community.png)
...
![](/images/java/20220703-learn-java-with-idea/ubuntu-download.png)
...
![解压](/images/java/20220703-learn-java-with-idea/unzip.png)

![解压后的目录结构](/images/java/20220703-learn-java-with-idea/strucrure.png)
...
![](/images/java/20220703-learn-java-with-idea/sh-idea.png)

4. 进入初始化启动后的设置即可。

首先是 UI 主题选择，根据自己的喜好选择 Light 还是 Darcula 模式；

![图片源自 IDEA 官网](/images/java/20220703-learn-java-with-idea/ui.png)

接着是否创建启动器脚本，同时选择自己的脚本保存目录

![图片源自 IDEA 官网](/images/java/20220703-learn-java-with-idea/shell-path.png)

接着选择自己想要的插件和禁用无关插件，根据自己的需求安装即可，如果不知道怎么选择，默认即可。

![图片源自 IDEA 官网](/images/java/20220703-learn-java-with-idea/plugin.png)

选择额外的插件支持，按需安装，默认不勾选，后续也可以自行安装。

![图片源自 IDEA 官网](/images/java/20220703-learn-java-with-idea/other-pulgin.png)
...
![](/images/java/20220703-learn-java-with-idea/uninstall.png)
...
![](/images/java/20220703-learn-java-with-idea/macos-down.png)

2.  然后双击下载好的 `.dmg` 安装包，等待验证后拖拽到 `Applications` 即可；

![](/images/java/20220703-learn-java-with-idea/macos-install.png)

3.  安装成功，打开的主页面如下图所示；

![](/images/java/20220703-learn-java-with-idea/idea-main-ui.png)

#### 3.2 卸载

打开访达中的 **应用程序**，然后找到 IDEA，将其拖到 **🗑️ 废纸篓** 即可，也可以单击鼠标右键，然后 **移到废纸篓**；

![](/images/java/20220703-learn-java-with-idea/uninstall-macos.png)
...
![](/images/java/20220703-learn-java-with-idea/new-project.png)

2.  下一步之后，如果勾选上面的选项，就会从模板创建一个项目（一般都是 `HelloWorld`），不勾选就是一个空项目，看自己选择；

![](/images/java/20220703-learn-java-with-idea/template.png)

3.  再接下来，就是设置项目名以及项目存储目录了；

![](/images/java/20220703-learn-java-with-idea/pro-name.png)

4.  最后点击完成，我们的普通 Java 项目就创建成功了；

![](/images/java/20220703-learn-java-with-idea/finish-pro.png)
...
![](/images/java/20220703-learn-java-with-idea/helloworld.png)
