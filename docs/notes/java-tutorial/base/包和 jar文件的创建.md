---
title: 包和jar文件的创建
createTime: 2025/08/28 10:33:46
permalink: /java-tutorial/base/gnv03z2c/
---
...
![](/images/java/20220711-oop-3/javadoc.png)

生成的文件列表详情见下图，打开其中的 `index.html` 就可以查看提取的文档注释。

![](/images/java/20220711-oop-3/index.png)

![](/images/java/20220711-oop-3/class.png)
...
![](/images/java/20220711-oop-3/compile.png)
...
![](/images/java/20220711-oop-3/main-class.png)
