---
title: 操作符
createTime: 2025/08/28 10:09:02
permalink: /java-tutorial/jve1vusx/
---


## 前言

之前的文章中介绍了 Java 变量和数据类型，那么如何对他们进行运算呢？这就要用到运算符的相关知识点了。所谓运算符，就是指 Java 中对变量或者字面量进行操作的符号。下面就来具体看看，常用的操作符。
...
![](/images/java/20220706-operator/operator.png)
...
![](/images/java/20220706-operator/logic.png)
...
![](/images/java/20220706-operator/bit.png)
...
![](/images/java/20220706-operator/assign.png)
...
![](/images/java/20220706-operator/condition.png)
...
![](/images/java/20220706-operator/equals.png)
