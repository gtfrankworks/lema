---
title: 控制流程
createTime: 2025/08/28 10:24:22
permalink: /java-tutorial/base/34kibaf6/
---
...
我们在上一篇文章中讲了各种操作符的使用技巧，接上一篇文章中的内容，本次文章主要将流程控制，文章主要内容安排如下：
...
![](/images/java/20220707-control-process/input.png)
...
![](/images/java/20220707-control-process/output.png)

## 顺序结构

![顺序结构](/images/java/20220707-control-process/sequence.png)

顺序结构如上图所示，它可以说是最简单的，只需要按照解决问题的顺序写出对应的语句即可，其执行顺序是自上而下，依次执行的。就类似于我们求解一道数学题，你得根据题意一步一步来，直至解出最后的答案。

## 分支结构

![分支结构](/images/java/20220707-control-process/condition.png)
...
![](/images/java/20220707-control-process/if.png)
...
![](/images/java/20220707-control-process/mul-if.png)
...
![](/images/java/20220707-control-process/if-res.png)
...
![循环结构](/images/java/20220707-control-process/loop.png)
...
![](/images/java/20220707-control-process/sum.png)
...
![](/images/java/20220707-control-process/while.png)
...
![](/images/java/20220707-control-process/dowhile.png)
...
![](/images/java/20220707-control-process/for.png)
...
![](/images/java/20220707-control-process/for-each.png)
...
![](/images/java/20220707-control-process/break.png)
...
![](/images/java/20220707-control-process/continue.png)
...
::: center
![](https://cdn.jsdelivr.net/gh/1943/1943@main/imgs/wepublic.gif =200x)
:::
