---
title: 开发环境搭建及入门程序
createTime: 2025/08/28 10:01:09
permalink: /java-tutorial/gpel98f2/
---
...
![](/images/java/20220702-jdk-install-and-hello-world/jdk11.png)

2.  点击 JDK Download 后，它会跳转到具体下载页面，然后根据自己的系统来进行选择，此处以 Windows 10 64 位为例；

![](/images/java/20220702-jdk-install-and-hello-world/download.png)

3.  点击最后的连接后，它会让你同意协议，勾选同意，然后登陆你的 Oracle 账户即可开始下载，若是没有 Oracle 账户，点击下面的创建一个即可；

![](/images/java/20220702-jdk-install-and-hello-world/agree.png)

![](/images/java/20220702-jdk-install-and-hello-world/login.png)

4.  下载完成后，进行安装即可，安装流程和我们平常安装软件的一样，就再赘述，需要注意的是要记住如下的安装路径，因为一般我们都不会安装到默认路径，所以一定要记住你所安装到的路径，这关系到后续的配置步骤；

![](/images/java/20220702-jdk-install-and-hello-world/install-path.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/jdk-config.png)

2.  点击高级后，就会打开如下界面，然后打开环境变量；

![](/images/java/20220702-jdk-install-and-hello-world/envi-vari.png)

3.  新建环境变量 **JAVA_HOME**，然后变量值填入刚才安装 JDK 的路径（刚才提醒过要记住！）；

![](/images/java/20220702-jdk-install-and-hello-world/java-home.png)

4.  编辑 **Path** 环境变量，然后新建一个变量值，填入如下内容：`%JAVA_HOME%\bin`；

![](/images/java/20220702-jdk-install-and-hello-world/path-bin.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/java-version.png)

![](/images/java/20220702-jdk-install-and-hello-world/javac.png)

![](/images/java/20220702-jdk-install-and-hello-world/java.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/macos-jdk.png)

2.  接受相关协议并登录下载；

3.  双击下载好的 `.dmg` 安装包，然后开始安装；

![](/images/java/20220702-jdk-install-and-hello-world/install-macos.png)

4.  安装过程中会让你输入密码，也就是你本机的密码。

![](/images/java/20220702-jdk-install-and-hello-world/pwd.png)

5.  安装成功；

![](/images/java/20220702-jdk-install-and-hello-world/success.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/macos-jdk-v.png)

2.  编译命令；

![](/images/java/20220702-jdk-install-and-hello-world/macos-javac.png)

3.  运行命令；

![](/images/java/20220702-jdk-install-and-hello-world/macos-java.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/sequence.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/helloworld.png)

![](/images/java/20220702-jdk-install-and-hello-world/java-class.png)
...
![](/images/java/20220702-jdk-install-and-hello-world/console-compiler.png)
