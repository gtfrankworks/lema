---
title: 泛型
createTime: 2025/08/28 14:13:05
permalink: /java-tutorial/advance/6bubby6h/
---


## 本章专题与脉络

<img src="/images/java/java1/第3阶段：Java高级应用-第13章.png" alt="第3阶段：Java高级应用-第13章" style="zoom: 67%;" />
...
![image-20220411000757577](/images/java/java1/image-20220411000757577.png)

- 举例2：超市购物架上很多瓶子，每个瓶子装的是什么，有标签

<img src="/images/java/java1/image-20220918230534965.png" alt="image-20220918230534965" style="zoom:67%;" />

- 举例3：家庭厨房中：

<img src="/images/java/java1/image-20220514191533296.png" alt="image-20220514191533296" style="zoom:67%;" />
...
![1563414367674](/images/java/java1/1563414367674.png)
...
![image-20220923154058074](/images/java/java1/image-20220923154058074.png)

![image-20220923154426871](/images/java/java1/image-20220923154426871.png)
...
<img src="/images/java/java1/image-20220411001522636.png" alt="image-20220411001522636" style="zoom:80%;" />

**集合中使用泛型时：**

<img src="/images/java/java1/image-20220411001549747.png" alt="image-20220411001549747" style="zoom:80%;" />
...
```java
package com.test.genericclass.use;
...
（2）矩形类Rectangle实现java.lang.Comparable接口，并指定泛型为Rectangle，重写int compareTo(T t)方法，按照矩形面积比较大小，面积相等的，按照周长比较大小。
...
- &lt;T&gt;：代表未知的数据类型，我们可以指定为&lt;String&gt;，&lt;Integer&gt;，等。
...
```java
package com.test.genericclass.define;
...
<img src="/images/java/java1/image-20220411003422259.png" alt="image-20220411003422259" style="zoom:67%;" />
...
<img src="/images/java/java1/image-20220411004301224.png" alt="image-20220411004301224" style="zoom:67%;" />
