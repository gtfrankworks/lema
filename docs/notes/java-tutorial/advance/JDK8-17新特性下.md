---
title: JDK8-17新特性下
createTime: 2025/08/28 14:46:43
permalink: /java-tutorial/advance/6dzqyhmg/
---
# 第18章_JDK8-17新特性（下）
...
- 调出jShell
 ...
 ![image-20220527205410620](/images/java/java1/image-20220527205410620.png)

- 获取帮助


 ![image-20220527205418073](/images/java/java1/image-20220527205418073.png)

- 基本使用


 ![image-20220527205429720](/images/java/java1/image-20220527205429720.png)

- 导入指定的包


 ![image-20220527205440068](/images/java/java1/image-20220527205440068.png)

- 默认已经导入如下的所有包：（包含java.lang包）


 ![image-20220527205445267](/images/java/java1/image-20220527205445267.png)

- 只需按下 Tab 键，就能自动补全代码


 ![image-20220527205451352](/images/java/java1/image-20220527205451352.png)

- 列出当前 session 里所有有效的代码片段


 ![image-20220527205458774](/images/java/java1/image-20220527205458774.png)

- 查看当前 session 下所有创建过的变量


 ![image-20220527205506632](/images/java/java1/image-20220527205506632.png)

- 查看当前 session 下所有创建过的方法


 ![image-20220527205513459](/images/java/java1/image-20220527205513459.png)
...
- 使用外部代码编辑器来编写 Java 代码
 ...
 ![image-20220527205519915](/images/java/java1/image-20220527205519915.png)
...
public void printHello() {
    System.out.println("马上2023年了，乐码祝所有的谷粉元旦快乐！");
}
printHello();
...
- 使用/open命令调用
 ...
 ![image-20220527205827712](/images/java/java1/image-20220527205827712.png)

- 退出jShell


 ![image-20220527205904000](/images/java/java1/image-20220527205904000.png)
...
声明一个成员变量，并初始化值为null
 ...
 ![image-20220528155628337](/images/java/java1/image-20220528155628337.png)

声明一个数组变量，并为数组静态初始化（省略new的情况下）

 ![image-20220528155436304](/images/java/java1/image-20220528155436304.png)

没有初始化的方法内的局部变量声明

 ![image-20220528155525774](/images/java/java1/image-20220528155525774.png)

方法的返回值类型

 ![image-20220528155537713](/images/java/java1/image-20220528155537713.png)

方法的参数类型

 ![image-20220528155549303](/images/java/java1/image-20220528155549303.png)

构造器的参数类型

 ![image-20220528155614708](/images/java/java1/image-20220528155614708.png)

作为catch块中异常类型

 ![image-20220528155640498](/images/java/java1/image-20220528155640498.png)

Lambda表达式中函数式接口的类型

 ![image-20220528155423180](/images/java/java1/image-20220528155423180.png)

方法引用中函数式接口的类型

 ![image-20220528155429055](/images/java/java1/image-20220528155429055.png)
...
![image-20220527233322495](/images/java/java1/image-20220527233322495.png)
...
![image-20220528212254705](/images/java/java1/image-20220528212254705.png)
...
![image-20220528212323729](/images/java/java1/image-20220528212323729.png)
...
![image-20220528212414676](/images/java/java1/image-20220528212414676.png)

![image-20220528212421319](/images/java/java1/image-20220528212421319.png)
