---
title: 反射机制
createTime: 2025/08/28 14:33:17
permalink: /java-tutorial/advance/49rnaz7r/
---


## 本章专题与脉络

![第3阶段：Java高级应用-第17章](/images/java/java1/第3阶段：Java高级应用-第17章.png)
...
<img src="/images/java/java1/image-20220417161529285.png" alt="image-20220417161529285" style="zoom:80%;" />

**从内存加载上看反射：**

![image-20220524101448625](/images/java/java1/image-20220524101448625.png)
...
<img src="/images/java/java1/image-20220417162559217.png" alt="image-20220417162559217" style="zoom:80%;" />
...
<img src="/images/java/java1/image-20220514180100176.png" alt="image-20220514180100176" style="zoom:80%;" />
...
```java
Class clazz = "www.lisi.com".getClass();
```
...
public class GetClassObject {
    ...
    public void test01() throws ClassNotFoundException{
        ...
        Class c3 = Class.forName("com.lisi.classtype.GetClassObject");
        Class c4 = ClassLoader.getSystemClassLoader().loadClass("com.lisi.classtype.GetClassObject");
...
![image-20220417173459849](/images/java/java1/image-20220417173459849.png)

### 3.2 类的加载过程

当程序主动使用某个类时，如果该类还未被加载到内存中，系统会通过加载、链接、初始化三个步骤来对该类进行初始化。如果没有意外，JVM将会连续完成这三个步骤，所以有时也把这三个步骤统称为类加载。

<img src="/images/java/java1/image-20220417171411631.png" alt="image-20220417171411631" style="zoom: 50%;" />
...
<img src="/images/java/java1/image-20220417173647473.png" alt="image-20220417173647473" style="zoom:67%;" />
...
<img src="/images/java/java1/image-20220417173616344.png" alt="image-20220417173616344" style="zoom: 80%;" />
...
<img src="/images/java/java1/image-20220417173819953.png" alt="image-20220417173819953" style="zoom:80%;" />
...
![image-20220417174032702](/images/java/java1/image-20220417174032702.png)
...
//        lisiClass obj = new lisiClass();//编译期间无法创建

        Class<?> clazz = Class.forName("com.lisi.ext.demo.lisiClass");
        //clazz代表com.lisi.ext.demo.lisiClass类型
        //clazz.newInstance()创建的就是lisiClass的对象
        Object obj = clazz.newInstance();
    ...
    public void test2()throws Exception{
        Class<?> clazz = Class.forName("com.lisi.ext.demo.lisiDemo");
        //java.lang.InstantiationException: com.lisi.ext.demo.lisiDemo
        //Caused by: java.lang.NoSuchMethodException: com.lisi.ext.demo.lisiDemo.<init>()
        //即说明lisiDemo没有无参构造，就没有无参实例初始化方法<init>
    ...
    public void test3()throws Exception{
         ...
         * 例如：public lisiDemo(String title, int num)
         */
        //(2)获取构造器对象
        ...
        Object obj = constructor.newInstance("江苏乐码",2022);
        System.out.println(obj);
    }
}
```
...
public class OtherTest {
    ...
    public void test2(){
        ...
        System.out.println(superclass);//class com.lisi.java1.Creature
    }
    /*
    	获取运行时类的所在的包
     */
    ...
    public void test6(){
        ...
        System.out.println(genericSuperclass);//com.lisi.java1.Creature<java.lang.String>
    }
}
...
public class TestField {
    public static void main(String[] args)throws Exception {
        //1、获取Student的Class对象
        Class clazz = Class.forName("com.lisi.reflect.Student");
...
<img src="/images/java/java1/image-20220417181700813.png" alt="image-20220417181700813" style="zoom:80%;" />
...
public class TestMethod {
    ...
    public void test02()throws Exception{
        ...
        //printInfo方法是静态方法
        printInfoMethod.invoke(null,"江苏乐码");
    }
}
...
public class ReflectionTest {
    ...
    @Test
    public void test1() throws Exception {
        String className = "com.lisi.java1.Person";
...
public class ReflectionTest {
    ...
    @Test
    public void test2() throws Exception {
        String info = (String) invoke("com.lisi.java1.Person", "show");
