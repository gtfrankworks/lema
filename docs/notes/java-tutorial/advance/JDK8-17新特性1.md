---
title: JDK8-17新特性1
createTime: 2025/08/28 14:36:21
permalink: /java-tutorial/hy4qhekf/
---


## 本章专题与脉络

![第3阶段：Java高级应用-第18章](/images/java/java1/第3阶段：Java高级应用-第18章.png)
...
![4428b288361296048](/images/java/java1/4428b288361296048.png)

### 1.4 各版本介绍

![jdkxintexing](/images/java/java1/jdkxintexing.jpg)
...
<img src="/images/java/java1/image-20220525200441935.png" alt="image-20220525200441935" style="zoom:80%;" />

> 链接：https://pan.baidu.com/s/15QrBUOvfE9vjlTzN_EeVLg 
> 提取码：yyds 

![image-20221213235332866](/images/java/java1/image-20221213235332866.png)
...
<img src="/images/java/java1/image-20220525201653599.png" alt="image-20220525201653599" style="zoom:80%;" />
...
<img src="/images/java/java1/lambda表达式.jpg" alt="lambda表达式" style="zoom:67%;" />

![image-20221111213355625](/images/java/java1/image-20221111213355625.png)
...
<img src="/images/java/java1/image-20220527101737072.png" alt="image-20220527101737072" style="zoom:67%;" />

- 从匿名类到 Lambda 的转换举例2

<img src="/images/java/java1/image-20220527101814203.png" alt="image-20220527101814203" style="zoom:80%;" />
...
<img src="/images/java/java1/image-20220527103215741.png" alt="image-20220527103215741" style="zoom:67%;" />
...
![](/images/java/java1/03-Overview.png)
...
<img src="/images/java/java1/image-20220527111442115.png" alt="image-20220527111442115" style="zoom: 80%;" />

举例2：

<img src="/images/java/java1/image-20220527111621424.png" alt="image-20220527111621424" style="zoom:80%;" />

作为参数传递 Lambda 表达式：

<img src="/images/java/java1/image-20220527111751485.png" alt="image-20220527111751485" style="zoom:80%;" />
...
```java
	@Test
	public void test1(){
		List<String> list = Arrays.asList("hello","java","lambda","lema");
		list.forEach(s -> System.out.println(s));
    }
	@Test
	public void test2(){
...
<img src="/images/java/java1/image-20220514180803311.png" alt="image-20220514180803311" style="zoom: 50%;" />
