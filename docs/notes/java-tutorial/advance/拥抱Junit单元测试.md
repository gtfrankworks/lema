---
title: 拥抱Junit单元测试
createTime: 2025/08/28 10:47:20
permalink: /java-tutorial/advance/83h8v5z9/
---
...
<img src="/images/java/20220718-test-with-junit/dependency.png" />
...
![](/images/java/20220718-test-with-junit/@test.png)

一般来讲，测试成功一般是绿色，而测试失败则是红色。

- 测试成功的界面

![](/images/java/20220718-test-with-junit/success.png)

- 测试失败的界面

![](/images/java/20220718-test-with-junit/fail.png)
...
![](/images/java/20220718-test-with-junit/assert.png)
